...
//            float srcW = kbW / 10.0f;
//            float srcH = kbH / 5.0f;
//
//            float drawX = selStartX + idx * (cellW + 4);
//            float drawY = selY;
//
//            Sprite_DrawZ(
//                g_TexKeyboardId,
...
//        if (g_TexFrameId >= 0)
//        {
//            int srcW = Texture_GetWidth(g_TexFrameId);
//            int srcH = Texture_GetHeight(g_TexFrameId);
//
//            float frameX = kbX + cursorCol * cellW;
//            float frameY = kbY + cursorRow * cellH;
//
//            Sprite_DrawZ(
//                g_TexFrameId,
//                frameX, frameY,
